...
struct ad7124StReg ad7124Regs[AD7124_REG_NO] = {
	{0x00, 0x00,   1, 2}, /* AD7124_Status */
	{0x01, 0x04C0, 2, 1}, /* AD7124_ADC_Control */		//Full Power mode. External Ref. Continuous conversion. CS_EN. Status appended
	...
	{0x0A, 0x8043, 2, 1}, /* AD7124_Channel_1 */
	{0x0B, 0x8085, 2, 1}, /* AD7124_Channel_2 */
	{0x0C, 0x80C7, 2, 1}, /* AD7124_Channel_3 */
	...
	{0x19, 0x0860, 2, 1}, /* AD7124_Config_0 */			//Ain buff enable. Bipolar. Refin1. Gain 1
	...
	{0x21, 0x010002, 3, 1}, /* AD7124_Filter_0 */		//Syn4 filter. Zero latency. FS = 2
